// Formato 5 (matriz 3×3) — PÚBLICO/standalone, embutível em apresentação.
...
export default function MatrizPublicoPage({ params }: { params: { docId: string } }) {
  const doc = getMontadorDoc(params.docId);
  if (!doc || !doc.disponivel || !doc.matriz) notFound();
  return (
    <div className="pagina-embed min-h-screen bg-gray-50 px-4 py-6">
      <div className="mx-auto max-w-2xl">
        ...
        <MontadorAtividade doc={doc} atividade="matriz" base="/montador" />
