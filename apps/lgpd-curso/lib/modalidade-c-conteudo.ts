...
export const ROTEIRO: MomentoRoteiro[] = [
  ...
  {
    dia: 1, numero: 3, titulo: "Termômetro Institucional (início)", duracao: "10 min", meio: "📱 celular",
    oQueFacilitadorFaz: "Explica que vão medir a maturidade percebida agora e repetir no fim.",
