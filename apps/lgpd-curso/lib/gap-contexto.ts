...
//
// Origem: extraído de lib/gap-catalog.ts do app principal PGP (28 domínios
// únicos · 119 controles totais).
...
export const DOMINIOS_GAP_COMPLETO: DominioGap[] = [
  { nome: "Estratégia de privacidade",                                                          qtdControles: 2, cobertoNoCurso: false, resumo: "Comitê, política institucional, alocação de recursos." },
  ...
  { nome: "Agentes de tratamento de dados",                                                     qtdControles: 1, cobertoNoCurso: false, resumo: "Distinção controlador / operador / encarregado documentada." },
  ...
  { nome: "Tratamento dos dados pessoais sensíveis — Crianças e adolescentes — Consentimento",  qtdControles: 2, cobertoNoCurso: false, resumo: "Art. 14 LGPD — consentimento específico do(a) responsável legal." },
  ...
  { nome: "Tratamento dos dados pessoais sensíveis — Compartilhamento entre controladores",     qtdControles: 1, cobertoNoCurso: false, resumo: "Quando 2+ controladores compartilham sensíveis." },
  ...
  { nome: "Tratamento dos dados pessoais — Anonimização",                                        qtdControles: 1, cobertoNoCurso: false, resumo: "Quando dá pra anonimizar e sair do escopo da LGPD." },
  ...
  { nome: "Tratamento dos dados pessoais — Dados públicos",                                      qtdControles: 1, cobertoNoCurso: false, resumo: "Cuidados com dados manifestamente tornados públicos." },
  { nome: "Tratamento dos dados pessoais — Tratamento de dados obrigatória",                    qtdControles: 1, cobertoNoCurso: false, resumo: "Hipóteses em que o tratamento é obrigatório por lei." },
  ...
  { nome: "Contratos",                                                                           qtdControles: 2, cobertoNoCurso: false, resumo: "Cláusulas LGPD em contratos com operadores. Feito na M4a, não testado no M3." },
