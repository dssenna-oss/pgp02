...
// 180s: folga confortável após upgrade Vercel Pro. Rota legada (1-shot
// scrape+LLM), não usada mais pela UI — mantida pra compat se alguém
// estiver chamando direto.
